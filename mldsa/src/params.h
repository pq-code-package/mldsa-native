...
#define MLDSA_POLYW1_PACKEDBITS_88 6
#define MLDSA_POLYW1_PACKEDBITS_32 4
#define MLDSA_POLYW1_PACKEDBYTES_88 (MLDSA_N * MLDSA_POLYW1_PACKEDBITS_88 / 8)
#define MLDSA_POLYW1_PACKEDBYTES_32 (MLDSA_N * MLDSA_POLYW1_PACKEDBITS_32 / 8)
...
#define MLDSA_POLYZ_PACKEDBITS 18
#define MLDSA_POLYW1_PACKEDBYTES MLDSA_POLYW1_PACKEDBYTES_88
#define MLDSA_POLYW1_PACKEDBITS MLDSA_POLYW1_PACKEDBITS_88
#define MLDSA_POLYETA_PACKEDBITS 3
...
#define MLDSA_POLYZ_PACKEDBITS 20
#define MLDSA_POLYW1_PACKEDBYTES MLDSA_POLYW1_PACKEDBYTES_32
#define MLDSA_POLYW1_PACKEDBITS MLDSA_POLYW1_PACKEDBITS_32
#define MLDSA_POLYETA_PACKEDBITS 4
...
#define MLDSA_POLYT1_PACKEDBITS 10

#define MLDSA_POLYT1_PACKEDBYTES (MLDSA_N * MLDSA_POLYT1_PACKEDBITS / 8)
#define MLDSA_POLYT0_PACKEDBYTES (MLDSA_N * MLDSA_D / 8)
#define MLDSA_POLYZ_PACKEDBYTES (MLDSA_N * MLDSA_POLYZ_PACKEDBITS / 8)
#define MLDSA_POLYETA_PACKEDBYTES (MLDSA_N * MLDSA_POLYETA_PACKEDBITS / 8)
