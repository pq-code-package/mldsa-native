...
#define MLD_AVX2_REJ_UNIFORM_BUFLEN (5 * 168) /* REJ_UNIFORM_NBLOCKS * SHAKE128_RATE */
#define MLD_AVX2_REJ_UNIFORM_ETA2_BUFLEN (1 * 136) /* POLY_UNIFORM_ETA_NBLOCKS * SHAKE256_RATE */
#define MLD_AVX2_REJ_UNIFORM_ETA4_BUFLEN (2 * 136) /* POLY_UNIFORM_ETA_NBLOCKS * SHAKE256_RATE */
