...
let mldsa_polyz_unpack_19_mc = define_assert_from_elf
  "mldsa_polyz_unpack_19_mc" "x86_64/mldsa/mldsa_polyz_unpack_19_avx2_asm.o"
(*** BYTECODE START ***)
[
...
let LENGTH_MLDSA_POLYZ_UNPACK_19_TMC =
  REWRITE_CONV[mldsa_polyz_unpack_19_tmc] `LENGTH mldsa_polyz_unpack_19_tmc`
  |> CONV_RULE(RAND_CONV LENGTH_CONV);;

let MLDSA_POLYZ_UNPACK_19_POSTAMBLE_LENGTH = new_definition
  `MLDSA_POLYZ_UNPACK_19_POSTAMBLE_LENGTH = 1`;;

let MLDSA_POLYZ_UNPACK_19_CORE_END = new_definition
  `MLDSA_POLYZ_UNPACK_19_CORE_END =
     LENGTH mldsa_polyz_unpack_19_tmc - MLDSA_POLYZ_UNPACK_19_POSTAMBLE_LENGTH`;;

let LENGTH_SIMPLIFY_CONV =
  REWRITE_CONV[LENGTH_MLDSA_POLYZ_UNPACK_19_TMC;
              MLDSA_POLYZ_UNPACK_19_CORE_END;
...
let MLDSA_POLYZ_UNPACK_19_CORRECT = prove
 (`!r b (l:(20 word) list) pc.
        ...
        ==> ensures x86
             ...
             (\s. read RIP s = word(pc + MLDSA_POLYZ_UNPACK_19_CORE_END) /\
...
let MLDSA_POLYZ_UNPACK_19_NOIBT_SUBROUTINE_CORRECT = prove
 (`!r b (l:(20 word) list) pc stackpointer returnaddress.
  ...
  X86_PROMOTE_RETURN_NOSTACK_TAC mldsa_polyz_unpack_19_tmc
   (CONV_RULE LENGTH_SIMPLIFY_CONV MLDSA_POLYZ_UNPACK_19_CORRECT) THEN
  REPEAT STRIP_TAC THEN
...
let full_spec,public_vars = mk_safety_spec
    ...
    (REWRITE_RULE[SOME_FLAGS] (CONV_RULE LENGTH_SIMPLIFY_CONV MLDSA_POLYZ_UNPACK_19_CORRECT))
...
let MLDSA_POLYZ_UNPACK_19_SAFE = time prove
 (full_spec,
