...
let mldsa_polyz_unpack_17_mc = define_assert_from_elf
  "mldsa_polyz_unpack_17_mc" "x86_64/mldsa/mldsa_polyz_unpack_17_avx2_asm.o"
(*** BYTECODE START ***)
[
...
let ZUNPACK17_FOLD_TAC (asl,w as gl) =
  let is_target th =
    ...
    can (find_term (fun t -> t = `word 131072:int32`)) c in
...
let MLDSA_POLYZ_UNPACK_17_SAFE = time prove
 (full_spec,
