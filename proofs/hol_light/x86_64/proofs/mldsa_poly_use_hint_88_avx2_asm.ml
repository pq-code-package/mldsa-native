...
let poly_use_hint_88_avx2_asm_mc = define_assert_from_elf
 "poly_use_hint_88_avx2_asm_mc" "x86_64/mldsa/mldsa_poly_use_hint_88_avx2_asm.o"
(*** BYTECODE START ***)
[
 ...
 (`exists f_events.
       forall e a h pc stackpointer returnaddress.
          ...
          ==> ensures x86
               ...
               (\s s'. true)`,
  X86_PROMOTE_RETURN_NOSTACK_TAC poly_use_hint_88_avx2_asm_tmc MLDSA_POLY_USE_HINT_88_SAFE THEN
