...
let mldsa_intt_mc = define_assert_from_elf "mldsa_intt_mc" "x86_64/mldsa/mldsa_intt_avx2_asm.o"
(*** BYTECODE START ***)
[
  ...
  0xc5; 0xdd; 0xfe; 0xe5;  (* VPADDD (%_% ymm4) (%_% ymm4) (%_% ymm5) *)
  ...
  0xc5; 0xcd; 0xfe; 0xf7;  (* VPADDD (%_% ymm6) (%_% ymm6) (%_% ymm7) *)
  0xc4; 0x62; 0x1d; 0x28; 0xe9;
                           (* VPMULDQ (%_% ymm13) (%_% ymm12) (%_% ymm1) *)
  ...
  0xc4; 0x41; 0x3d; 0xfe; 0xc1;
                           (* VPADDD (%_% ymm8) (%_% ymm8) (%_% ymm9) *)
  0xc4; 0x62; 0x1d; 0x28; 0xe9;
                           (* VPMULDQ (%_% ymm13) (%_% ymm12) (%_% ymm1) *)
  ...
  0xc5; 0xdd; 0xfe; 0xe7;  (* VPADDD (%_% ymm4) (%_% ymm4) (%_% ymm7) *)
  0xc4; 0x62; 0x1d; 0x28; 0xe9;
                           (* VPMULDQ (%_% ymm13) (%_% ymm12) (%_% ymm1) *)
  0xc4; 0xc1; 0x7e; 0x16; 0xfc;
                           (* VMOVSHDUP (%_% ymm7) (%_% ymm12) *)
  ...
  0xc4; 0x41; 0x3d; 0xfe; 0xc3;
                           (* VPADDD (%_% ymm8) (%_% ymm8) (%_% ymm11) *)
  0xc4; 0x62; 0x1d; 0x28; 0xe9;
                           (* VPMULDQ (%_% ymm13) (%_% ymm12) (%_% ymm1) *)
  0xc4; 0x41; 0x7e; 0x16; 0xdc;
                           (* VMOVSHDUP (%_% ymm11) (%_% ymm12) *)
...
let MLDSA_INTT_NOIBT_SUBROUTINE_SAFE = time prove
 (`exists f_events.
       forall e a zetas pc stackpointer returnaddress.
          ...
          ==> ensures x86
               (\s. bytes_loaded s (word pc) mldsa_intt_tmc /\
                    ...
                    read (memory :> bytes64 stackpointer) s = returnaddress /\
                    C_ARGUMENTS [a; zetas] s /\ read events s = e)
               (\s. read RIP s = returnaddress /\
                    read RSP s = word_add stackpointer (word 8) /\
  ...
  X86_PROMOTE_RETURN_NOSTACK_TAC mldsa_intt_tmc
    MLDSA_INTT_SAFE THEN DISCHARGE_SAFETY_PROPERTY_TAC);;
