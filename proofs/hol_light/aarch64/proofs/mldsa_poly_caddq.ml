...
[
  ...
  0xad400400;       (* arm_LDP Q0 Q1 X0 (Immediate_Offset (iword (&0))) *)
  0xad410c02;       (* arm_LDP Q2 Q3 X0 (Immediate_Offset (iword (&32))) *)
  ...
  0xad010c02;       (* arm_STP Q2 Q3 X0 (Immediate_Offset (iword (&32))) *)
  0xac820400;       (* arm_STP Q0 Q1 X0 (Postimmediate_Offset (iword (&64))) *)
  0xf1000421;       (* arm_SUBS X1 X1 (rvalue (word 1)) *)
  0x54fffe61;       (* arm_BNE (word 2097100) *)
