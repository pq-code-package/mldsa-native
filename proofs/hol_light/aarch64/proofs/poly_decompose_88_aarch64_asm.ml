...
let poly_decompose_88_aarch64_asm_mc = define_assert_from_elf "poly_decompose_88_aarch64_asm_mc" "aarch64/mldsa/poly_decompose_88_aarch64_asm.o"
(*** BYTECODE START ***)
[
  ...
  0x4f2f2463;       (* arm_SRSHR_VEC Q3 Q3 17 32 128 *)
  0x4eb7b758;       (* arm_SQDMULH_VEC Q24 Q26 Q23 32 128 *)
  0x4f2f267b;       (* arm_SRSHR_VEC Q27 Q19 17 32 128 *)
  0x6eb69471;       (* arm_MLS_VEC Q17 Q3 Q22 32 128 *)
  0x4f2f24fd;       (* arm_SRSHR_VEC Q29 Q7 17 32 128 *)
  ...
  0x4f2f261d;       (* arm_SRSHR_VEC Q29 Q16 17 32 128 *)
  ...
  0x3c9f0031;       (* arm_STR Q17 X1 (Immediate_Offset (word 18446744073709551600)) *)
  0x4f2f247f;       (* arm_SRSHR_VEC Q31 Q3 17 32 128 *)
  0x4eb7b4a1;       (* arm_SQDMULH_VEC Q1 Q5 Q23 32 128 *)
  0x4eb53606;       (* arm_CMGT_VEC Q6 Q16 Q21 32 128 *)
  0x4f2f2718;       (* arm_SRSHR_VEC Q24 Q24 17 32 128 *)
  0x4f2f2799;       (* arm_SRSHR_VEC Q25 Q28 17 32 128 *)
  ...
  0x4f2f243e;       (* arm_SRSHR_VEC Q30 Q1 17 32 128 *)
  0x6eb69720;       (* arm_MLS_VEC Q0 Q25 Q22 32 128 *)
  0x4e621f3c;       (* arm_BIC_VEC Q28 Q25 Q2 128 *)
  0x4f2f2687;       (* arm_SRSHR_VEC Q7 Q20 17 32 128 *)
...
let POLY_DECOMPOSE_88_AARCH64_ASM_SUBROUTINE_SAFE = time prove
 (`exists f_events.
       forall e pc a r1 returnaddress.
           ...
           nonoverlapping (word pc,LENGTH poly_decompose_88_aarch64_asm_mc) (a,1024) /\
           nonoverlapping (r1,1024) (a,1024)
           ==> ensures arm
               (\s.
