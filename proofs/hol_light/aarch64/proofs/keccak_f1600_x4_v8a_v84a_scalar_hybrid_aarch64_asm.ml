...
(**** print_literal_from_elf "aarch64/mldsa/keccak_f1600_x4_v8a_v84a_scalar_hybrid_aarch64_asm.o";;
 ****)

let keccak_f1600_x4_v8a_v84a_scalar_mc = define_assert_from_elf
  "keccak_f1600_x4_v8a_v84a_scalar_mc" "aarch64/mldsa/keccak_f1600_x4_v8a_v84a_scalar_hybrid_aarch64_asm.o"
(*** BYTECODE START ***)
[
...
let KECCAK_F1600_X4_V8A_V84A_SCALAR_HYBRID_EXEC = ARM_MK_EXEC_RULE keccak_f1600_x4_v8a_v84a_scalar_mc;;
...
let LENGTH_KECCAK_F1600_X4_V8A_V84A_SCALAR_HYBRID_MC =
  REWRITE_CONV[keccak_f1600_x4_v8a_v84a_scalar_mc] `LENGTH keccak_f1600_x4_v8a_v84a_scalar_mc`
  |> CONV_RULE (RAND_CONV LENGTH_CONV);;

let KECCAK_F1600_X4_V8A_V84A_SCALAR_HYBRID_PREAMBLE_LENGTH = new_definition
  `KECCAK_F1600_X4_V8A_V84A_SCALAR_HYBRID_PREAMBLE_LENGTH = 44`;;

let KECCAK_F1600_X4_V8A_V84A_SCALAR_HYBRID_POSTAMBLE_LENGTH = new_definition
  `KECCAK_F1600_X4_V8A_V84A_SCALAR_HYBRID_POSTAMBLE_LENGTH = 48`;;

let KECCAK_F1600_X4_V8A_V84A_SCALAR_HYBRID_CORE_START = new_definition
  `KECCAK_F1600_X4_V8A_V84A_SCALAR_HYBRID_CORE_START = KECCAK_F1600_X4_V8A_V84A_SCALAR_HYBRID_PREAMBLE_LENGTH`;;

let KECCAK_F1600_X4_V8A_V84A_SCALAR_HYBRID_CORE_END = new_definition
  `KECCAK_F1600_X4_V8A_V84A_SCALAR_HYBRID_CORE_END = LENGTH keccak_f1600_x4_v8a_v84a_scalar_mc - KECCAK_F1600_X4_V8A_V84A_SCALAR_HYBRID_POSTAMBLE_LENGTH`;;

let LENGTH_SIMPLIFY_CONV =
  REWRITE_CONV[LENGTH_KECCAK_F1600_X4_V8A_V84A_SCALAR_HYBRID_MC;
              KECCAK_F1600_X4_V8A_V84A_SCALAR_HYBRID_CORE_START; KECCAK_F1600_X4_V8A_V84A_SCALAR_HYBRID_CORE_END;
              KECCAK_F1600_X4_V8A_V84A_SCALAR_HYBRID_PREAMBLE_LENGTH; KECCAK_F1600_X4_V8A_V84A_SCALAR_HYBRID_POSTAMBLE_LENGTH] THENC
...
let KECCAK_F1600_X4_V8A_V84A_SCALAR_HYBRID_CORRECT = prove
 (`!a rc A1 A2 A3 A4 pc stackpointer.
      ...
      ==> ensures arm
           (\s. aligned_bytes_loaded s (word pc) keccak_f1600_x4_v8a_v84a_scalar_mc /\
                read PC s = word (pc + KECCAK_F1600_X4_V8A_V84A_SCALAR_HYBRID_CORE_START) /\
           ...
           (\s. read PC s = word(pc + KECCAK_F1600_X4_V8A_V84A_SCALAR_HYBRID_CORE_END) /\
  ...
  REWRITE_TAC[fst KECCAK_F1600_X4_V8A_V84A_SCALAR_HYBRID_EXEC] THEN
  ...
  REWRITE_TAC[condition_semantics] THEN REPEAT CONJ_TAC THENL
   [ARITH_TAC;
    ...
    ARM_STEPS_TAC KECCAK_F1600_X4_V8A_V84A_SCALAR_HYBRID_EXEC (1--396) THEN
    ...
    ARM_STEPS_TAC KECCAK_F1600_X4_V8A_V84A_SCALAR_HYBRID_EXEC (1--339) THEN
    ...
    CONV_TAC(ONCE_DEPTH_CONV WORDLIST_FROM_MEMORY_CONV) THEN
    CONV_TAC(ONCE_DEPTH_CONV NORMALIZE_RELATIVE_ADDRESS_CONV) THEN
    ARM_SIM_TAC KECCAK_F1600_X4_V8A_V84A_SCALAR_HYBRID_EXEC [1] THEN
  ...
  REWRITE_TAC[condition_semantics] THEN REPEAT CONJ_TAC THENL
   [ARITH_TAC;
    ...
    ENSURES_INIT_TAC "s0" THEN
    ARM_STEPS_TAC KECCAK_F1600_X4_V8A_V84A_SCALAR_HYBRID_EXEC (1--395) THEN
  ...
  REWRITE_TAC[GSYM round_constants] THEN
  ENSURES_INIT_TAC "s0" THEN
  ARM_STEPS_TAC KECCAK_F1600_X4_V8A_V84A_SCALAR_HYBRID_EXEC (1--83) THEN
  ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
  CONV_TAC(ONCE_DEPTH_CONV WORDLIST_FROM_MEMORY_CONV) THEN
  CONV_TAC(ONCE_DEPTH_CONV NORMALIZE_RELATIVE_ADDRESS_CONV) THEN
  ASM_REWRITE_TAC[] THEN
 ...
 * in mldsa/src/fips202/native/aarch64/src/fips202_native_aarch64.h *)

let KECCAK_F1600_X4_V8A_V84A_SCALAR_HYBRID_SUBROUTINE_CORRECT = prove
...
let full_spec,public_vars = mk_safety_spec
    ...
    KECCAK_F1600_X4_V8A_V84A_SCALAR_HYBRID_SUBROUTINE_CORRECT
    KECCAK_F1600_X4_V8A_V84A_SCALAR_HYBRID_EXEC;;

let KECCAK_F1600_X4_V8A_V84A_SCALAR_HYBRID_SUBROUTINE_SAFE = time prove
 (`exists f_events.
  ...
  PROVE_SAFETY_SPEC_TAC ~public_vars:public_vars KECCAK_F1600_X4_V8A_V84A_SCALAR_HYBRID_EXEC);;
