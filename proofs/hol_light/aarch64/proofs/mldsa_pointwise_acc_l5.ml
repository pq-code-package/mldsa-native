...
let mldsa_pointwise_acc_l5_mc = define_assert_from_elf
 "mldsa_pointwise_acc_l5_mc" "aarch64/mldsa/mldsa_pointwise_acc_l5.o"
(*** BYTECODE START ***)
[
  ...
  0xad414c32;       (* arm_LDP Q18 Q19 X1 (Immediate_Offset (iword (&32))) *)
  0xacc24430;       (* arm_LDP Q16 Q17 X1 (Postimmediate_Offset (iword (&64))) *)
  0xad415c56;       (* arm_LDP Q22 Q23 X2 (Immediate_Offset (iword (&32))) *)
  0xacc25454;       (* arm_LDP Q20 Q21 X2 (Postimmediate_Offset (iword (&64))) *)
  ...
  0xad014c12;       (* arm_STP Q18 Q19 X0 (Immediate_Offset (iword (&32))) *)
  0xac824410;       (* arm_STP Q16 Q17 X0 (Postimmediate_Offset (iword (&64))) *)
  0xf1001063;       (* arm_SUBS X3 X3 (rvalue (word 4)) *)
  0xb5fff3a3;       (* arm_CBNZ X3 (word 2096756) *)
