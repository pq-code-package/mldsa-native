...
let poly_use_hint_88_aarch64_asm_mc = define_assert_from_elf
 "poly_use_hint_88_aarch64_asm_mc" "aarch64/mldsa/poly_use_hint_88_aarch64_asm.o"
(*** BYTECODE START ***)
[
  ...
  ARM_ADD_RETURN_NOSTACK_TAC POLY_USE_HINT_88_AARCH64_ASM_EXEC
    (CONV_RULE(ONCE_DEPTH_CONV NUM_REDUCE_CONV)
      (REWRITE_RULE[fst POLY_USE_HINT_88_AARCH64_ASM_EXEC]
         POLY_USE_HINT_88_AARCH64_ASM_CORRECT_BOUND_CODE)));;
...
(* Postcondition is stated in terms of mldsa_use_hint_88 from FIPS 204
   ...
   Derived from POLY_USE_HINT_88_AARCH64_ASM_SUBROUTINE_CORRECT_CODE by
...
let POLY_USE_HINT_88_AARCH64_ASM_SUBROUTINE_CORRECT = prove
 (`!b a h x y pc returnaddress.
  ...
  [REPEAT STRIP_TAC THEN MATCH_MP_TAC MLDSA_USE_HINT_88_EQUIV THEN
   ...
   MATCH_MP_TAC POLY_USE_HINT_88_AARCH64_ASM_SUBROUTINE_CORRECT_CODE THEN
   ASM_REWRITE_TAC[]]);;
...
let full_spec,public_vars = mk_safety_spec
    ...
    POLY_USE_HINT_88_AARCH64_ASM_SUBROUTINE_CORRECT_CODE
