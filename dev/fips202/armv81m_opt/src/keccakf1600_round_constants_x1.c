...
/*
 * Scalar x1 Keccak round constants in bit-interleaved form.
 ...
 * The final word is the permutation loop terminator.
 */
...
MLD_EMPTY_CU(fips202_armv81m_round_constants_x1)
