...
Makefile invokes SLOTHY with the `Arm_v7M` architecture model and
`Arm_Cortex_M7` target model; regenerate through
`scripts/autogen --slothy keccak_f1600_x1_armv7m_opt_m7` with `slothy-cli`
available in `PATH`.
