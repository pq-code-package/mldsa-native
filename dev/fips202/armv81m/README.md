...
implementation. The scalar x1 permutation is maintained in
[`../armv81m_opt/src/`](../armv81m_opt/src/) and is generated by SLOTHY from
[`../armv81m_clean/src/`](../armv81m_clean/src/). Autogeneration combines the
source files from `src/` and `../armv81m_opt/src/` into the production backend.
