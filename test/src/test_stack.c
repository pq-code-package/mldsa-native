...
static int test_keygen_only(void)
{
...
static int test_sign_only(void)
{
...
static int test_verify_only(void)
{
...
int main(int argc, char *argv[])
{
  ...
  {
    return test_keygen_only();
  }
  else if (strcmp(argv[1], "sign") == 0)
  {
    return test_sign_only();
  }
  else if (strcmp(argv[1], "verify") == 0)
  {
    return test_verify_only();
  }
  else
  {
