...
#define MLD_TOTAL_ALLOC_KEYPAIR \
  MLD_TOTAL_ALLOC_KEYPAIR_(MLD_CONFIG_PARAMETER_SET)

#define MLD_TOTAL_ALLOC_SIGN__(LVL) MLD_TOTAL_ALLOC_##LVL##_SIGN
#define MLD_TOTAL_ALLOC_SIGN_(LVL) MLD_TOTAL_ALLOC_SIGN__(LVL)
#define MLD_TOTAL_ALLOC_SIGN MLD_TOTAL_ALLOC_SIGN_(MLD_CONFIG_PARAMETER_SET)
...
#define MLD_TOTAL_ALLOC_VERIFY MLD_TOTAL_ALLOC_VERIFY_(MLD_CONFIG_PARAMETER_SET)
...
#define MLD_TOTAL_ALLOC_PK_FROM_SK \
  MLD_TOTAL_ALLOC_PK_FROM_SK_(MLD_CONFIG_PARAMETER_SET)

#define MLD_TOTAL_ALLOC__(LVL) MLD_TOTAL_ALLOC_##LVL
#define MLD_TOTAL_ALLOC_(LVL) MLD_TOTAL_ALLOC__(LVL)
#define MLD_TOTAL_ALLOC MLD_TOTAL_ALLOC_(MLD_CONFIG_PARAMETER_SET)
