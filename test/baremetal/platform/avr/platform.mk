...
# ML-DSA needs close to the full 64K data address space of the AVR
# architecture. No MCU supported by simavr has that much RAM, so we use
# ATMega128rfr2 with its RAM specification in simavr bumped from 16K to
# the maximal 63.5K (0x0200-0xFFFF).
