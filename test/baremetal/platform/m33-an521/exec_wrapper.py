...
"""QEMU wrapper for executing Cortex-M33 bare-metal ELF binaries (mps2-an521)."""
...
try:
    qemu_cmd = f"qemu-system-arm -M mps2-an521 -cpu cortex-m33 -nographic -semihosting -kernel {binpath} -device loader,file={args_file},addr=0x{cmdline_offset:x}".split()
