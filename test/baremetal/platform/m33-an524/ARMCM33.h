...
typedef struct
{
  ...
  __IOM uint32_t  INTSTATUS;     /*!< Offset: 0x00C (R/ ) Interrupt Status Register */
...
#define MPS3_UART_DATA_Msk               (0xFFUL << MPS3_UART_DATA_Pos)             /*!< MPS3_UART_DATA: DATA Mask */

/* UART STATE Register Definitions */
#define MPS3_UART_STATE_RXOR_Pos         3                                          /*!< MPS3_UART_STATE: RXOR Position */
#define MPS3_UART_STATE_RXOR_Msk         (0x1UL << MPS3_UART_STATE_RXOR_Pos)       /*!< MPS3_UART_STATE: RXOR Mask */

#define MPS3_UART_STATE_TXOR_Pos         2                                          /*!< MPS3_UART_STATE: TXOR Position */
#define MPS3_UART_STATE_TXOR_Msk         (0x1UL << MPS3_UART_STATE_TXOR_Pos)       /*!< MPS3_UART_STATE: TXOR Mask */

#define MPS3_UART_STATE_RXBF_Pos         1                                          /*!< MPS3_UART_STATE: RXBF Position */
#define MPS3_UART_STATE_RXBF_Msk         (0x1UL << MPS3_UART_STATE_RXBF_Pos)       /*!< MPS3_UART_STATE: RXBF Mask */

#define MPS3_UART_STATE_TXBF_Pos         0                                          /*!< MPS3_UART_STATE: TXBF Position */
#define MPS3_UART_STATE_TXBF_Msk         (0x1UL << MPS3_UART_STATE_TXBF_Pos)       /*!< MPS3_UART_STATE: TXBF Mask */

/* UART CTRL Register Definitions */
#define MPS3_UART_CTRL_HSTM_Pos          6                                          /*!< MPS3_UART_CTRL: HSTM Position */
#define MPS3_UART_CTRL_HSTM_Msk          (0x01UL << MPS3_UART_CTRL_HSTM_Pos)       /*!< MPS3_UART_CTRL: HSTM Mask */

#define MPS3_UART_CTRL_RXORIRQEN_Pos     5                                          /*!< MPS3_UART_CTRL: RXORIRQEN Position */
#define MPS3_UART_CTRL_RXORIRQEN_Msk     (0x01UL << MPS3_UART_CTRL_RXORIRQEN_Pos)  /*!< MPS3_UART_CTRL: RXORIRQEN Mask */

#define MPS3_UART_CTRL_TXORIRQEN_Pos     4                                          /*!< MPS3_UART_CTRL: TXORIRQEN Position */
#define MPS3_UART_CTRL_TXORIRQEN_Msk     (0x01UL << MPS3_UART_CTRL_TXORIRQEN_Pos)  /*!< MPS3_UART_CTRL: TXORIRQEN Mask */

#define MPS3_UART_CTRL_RXIRQEN_Pos       3                                          /*!< MPS3_UART_CTRL: RXIRQEN Position */
#define MPS3_UART_CTRL_RXIRQEN_Msk       (0x01UL << MPS3_UART_CTRL_RXIRQEN_Pos)    /*!< MPS3_UART_CTRL: RXIRQEN Mask */

#define MPS3_UART_CTRL_TXIRQEN_Pos       2                                          /*!< MPS3_UART_CTRL: TXIRQEN Position */
#define MPS3_UART_CTRL_TXIRQEN_Msk       (0x01UL << MPS3_UART_CTRL_TXIRQEN_Pos)    /*!< MPS3_UART_CTRL: TXIRQEN Mask */

#define MPS3_UART_CTRL_RXEN_Pos          1                                          /*!< MPS3_UART_CTRL: RXEN Position */
#define MPS3_UART_CTRL_RXEN_Msk          (0x01UL << MPS3_UART_CTRL_RXEN_Pos)       /*!< MPS3_UART_CTRL: RXEN Mask */

#define MPS3_UART_CTRL_TXEN_Pos          0                                          /*!< MPS3_UART_CTRL: TXEN Position */
#define MPS3_UART_CTRL_TXEN_Msk          (0x01UL << MPS3_UART_CTRL_TXEN_Pos)       /*!< MPS3_UART_CTRL: TXEN Mask */
...
typedef struct
{
  ...
  __IOM uint32_t  INTSTATUS;     /*!< Offset: 0x010 (R/W) Interrupt Status Register */
} MPS3_TIMER_TypeDef;
...
typedef struct
{
  ...
  __IOM uint32_t  Timer1Value;    /*!< Offset: 0x004 (R/ ) Timer 1 Current Value Register */
  __IOM uint32_t  Timer1Control;  /*!< Offset: 0x008 (R/W) Timer 1 Control Register */
  __IOM uint32_t  Timer1IntClr;   /*!< Offset: 0x00C ( /W) Timer 1 Interrupt Clear Register */
  __IOM uint32_t  Timer1RIS;      /*!< Offset: 0x010 (R/ ) Timer 1 Raw Interrupt Status Register */
  __IOM uint32_t  Timer1MIS;      /*!< Offset: 0x014 (R/ ) Timer 1 Masked Interrupt Status Register */
  __IOM uint32_t  Timer1BGLoad;   /*!< Offset: 0x018 (R/W) Timer 1 Background Load Register */
        uint32_t  RESERVED0[1];
  __IOM uint32_t  Timer2Load;     /*!< Offset: 0x020 (R/W) Timer 2 Load Register */
  __IOM uint32_t  Timer2Value;    /*!< Offset: 0x024 (R/ ) Timer 2 Current Value Register */
  __IOM uint32_t  Timer2Control;  /*!< Offset: 0x028 (R/W) Timer 2 Control Register */
  __IOM uint32_t  Timer2IntClr;   /*!< Offset: 0x02C ( /W) Timer 2 Interrupt Clear Register */
  __IOM uint32_t  Timer2RIS;      /*!< Offset: 0x030 (R/ ) Timer 2 Raw Interrupt Status Register */
  __IOM uint32_t  Timer2MIS;      /*!< Offset: 0x034 (R/ ) Timer 2 Masked Interrupt Status Register */
  __IOM uint32_t  Timer2BGLoad;   /*!< Offset: 0x038 (R/W) Timer 2 Background Load Register */
