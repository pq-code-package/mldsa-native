 ...
 * mld_bootargs_block, then continues. Zephyr parses the command line and calls
...
extern int mld_test_main(int argc, char **argv);
...
__asm__(
    ".global mld_bootargs_block\n"
    ".set mld_bootargs_block, 0x340b0000\n");

extern char mld_bootargs_block[BOOTARGS_BLOCK_SIZE];
...
{
  return mld_bootargs_block;
}

int main(int argc, char **argv)
{
  int rc = mld_test_main(argc, argv);
